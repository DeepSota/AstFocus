...
def parse_opts():
    ...
    parser.add_argument('--video_root', default='E:/video_attack/dataset/K400', type=str, help='Root path of input videos')
    parser.add_argument('--model', default='models/c3d_k400_model/models/checkpoints/resnet-18-kinetics.pth', type=str, help='Model file path')
