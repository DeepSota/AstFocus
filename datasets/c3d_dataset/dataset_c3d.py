...
from datasets.c3d_dataset.hmdb51 import HMDB51
from datasets.c3d_dataset.ucf101 import UCF101
from datasets.c3d_dataset.Yutils import get_mean, get_std
...
def get_test_set(dataset):
    ...
    if dataset == 'hmdb51':
        with open('C:/Users/86173/Desktop/EVA_RE/datasets/c3d_dataset/hmdb51_params.pkl', 'rb') as ipt:
            opt = pickle.load(ipt)
        opt = DictToAttr(opt)
    elif dataset == 'ucf101':
        with open('C:/Users/86173/Desktop/EVA_RE/datasets/c3d_dataset/ucf101_params.pkl', 'rb') as ipt:
            opt = pickle.load(ipt)
        opt = DictToAttr(opt)
