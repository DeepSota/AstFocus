...
def generate_model(model_name, dataset_name):
    assert model_name in ['c3d', 'i3d', 'tsm','tsn', 'slowonly']
    if model_name == 'c3d':
        if dataset_name == 'k400':
    ...
    if model_name=='slowonly':
        if dataset_name == 'ucf101':
            cfg = Config.fromfile('configs/recognition/slowonly/slowonly_k400_pretrained_r50_8x4x1_40e_ucf101_rgb.py')
        ...
        if dataset_name =='hmdb51':
            cfg = Config.fromfile('configs/recognition/slowonly/slowonly_k400_pretrained_r50_8x4x1_40e_hmdb51_rgb.py')
            checkpoint_path ='configs/checkpoints/slowonly_k400_pretrained_r50_8x4x1_40e_hmdb51_rgb_20210630-cee5f725.pth'
            model= init_recognizer(cfg, checkpoint_path, device='cuda:0').eval()
        if dataset_name =='k400':
            cfg = Config.fromfile('configs/recognition/slowonly/slowonly_r50_8x8x1_256e_kinetics400_rgb.py')
